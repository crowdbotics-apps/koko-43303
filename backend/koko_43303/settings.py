"""
Django settings for koko_43303 project.
...
WSGI_APPLICATION = 'koko_43303.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "koko_43303 API",
    "DESCRIPTION": "API documentation for koko_43303 App",
    "VERSION": "v1",
}
